...
GunCFG.Info = {
    ...
    ["smallarms2"] = {
        ...
        weapons = {
            {name = "M1911", price = 50000, hash = "WEAPON_M1911HVC", model = "w_pi_m1911"},
            {name = "Makarov", price = 60000, hash = "WEAPON_MAKAROVHVC", model = "w_pi_makarov"},
            {name = "UZI", price = 190000, hash = "WEAPON_UZIHVC", model = "w_sb_uzi"},
        },
        maxarmour = 25
    ...
    ["large"] = {
        ...
        weapons = {
            ...
            {name = "AK-74 Kashnar", price = 650000, hash = "WEAPON_KASHNARHVC", model = "w_ar_ak74kashnar"},
    ...
    ["rebel"] = {
        ...
        weapons = {
            ...
            {name = "Mosin Nagant", price = 900000, hash = "WEAPON_MOSINHVC", model = "w_ar_mosin"},
    ...
    ["vip"] = {
        ...
        Name = "VIP Store",
        weapons = {
            {name = "AK-74 Kashnar", price = 750000, hash = "WEAPON_KASHNARHVC", model = "w_ar_ak74kashnar"},
            {name = "Parachute", price = 10000, hash = "GADGET_PARACHUTE", model = "p_parachute_s"},
        },
        maxarmour = 100
    },  
