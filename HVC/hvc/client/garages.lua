...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('HVCGarages', 'main')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            RageUI.Button("Rent Manager", "", {}, true, function(Hovered, Active, Selected) end, RMenu:Get("HVCGarages", "rented_vehicles"))
    ...
    if RageUI.Visible(RMenu:Get('HVCGarages', 'owned_vehicles_submenu_manage')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if not RentedVeh then 
                RageUI.Button('Scrap Vehicle', "", {}, true, function(Hovered, Active, Selected)end,RMenu:Get("HVCGarages", "scrap_vehicle_confirmation"))
