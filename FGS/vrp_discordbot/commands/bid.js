...
exports.runcmd = (fivemexports, client, message, params) => {
    ...
    fivemexports.sql.execute("SELECT * FROM `vrp_user_ids` WHERE identifier = ?", ["discord:" + user.id], (result) => {
        if (result.length > 0) {
            fivemexports.sql.execute("SELECT * FROM vrp_user_moneys WHERE user_id = ?", [result[0].user_id], (result) => {
