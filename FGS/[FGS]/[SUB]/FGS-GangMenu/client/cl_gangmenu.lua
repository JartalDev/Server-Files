RMenu.Add('gangmenu', 'main', RageUI.CreateMenu("", "FGS Gang Menu", 1300, 100, "gang", "gang"))
...
RageUI.CreateWhile(1.0, RMenu:Get('gangmenu', 'creategang'), nil, function()
    RageUI.IsVisible(RMenu:Get('gangmenu', 'notingang'), true, false, true, function()
        ...
        RageUI.ButtonWithStyle("Create Gang", "Costs 1 million", { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
            if Selected then
            end
    ...
    RageUI.IsVisible(RMenu:Get("gangmenu", "confirmgang"),true, false,true,function()
        ...
        if Name ~= nil and Leader ~= nil then 
