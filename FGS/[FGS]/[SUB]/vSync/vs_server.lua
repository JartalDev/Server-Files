...
function NextWeatherStage()
    if CurrentWeather == "CLEAR" or CurrentWeather == "CLEAR" or CurrentWeather == "EXTRASUNNY"  then
    ...
    elseif CurrentWeather == "CLEARING" or CurrentWeather == "CLEAR" then
        local new = math.random(1,6)
        if new == 1 then
            if CurrentWeather == "CLEARING" then CurrentWeather = "EXTRASUNNY" else CurrentWeather = "CLEAR" end
        elseif new == 2 then
