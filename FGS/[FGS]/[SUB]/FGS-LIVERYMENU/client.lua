RMenu.Add('LiveryMenu', 'main', RageUI.CreateMenu("", "~w~FGS Livery Menu", 1300, 50, "livery", "livery"))
RMenu.Add('LiveryMenu', 'submain', RageUI.CreateSubMenu(RMenu:Get('LiveryMenu', 'main'), "", "~w~FGS Livery Menu", 1300, 50, "livery", "livery"))
