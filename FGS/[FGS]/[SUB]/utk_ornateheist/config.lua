...
Config.PermCops = "police.pc"	-- Cops permission
Config.MinCops = 0					-- Amount of cops required to start heist
Config.mincash = 20000 				-- Minimum amount of cash a pile holds
Config.maxcash = 30000			-- Maximum amount of cash a pile can hold
