...
RegisterNetEvent('FGS:LootAnim')
AddEventHandler('FGS:LootAnim', function()
                    ...
                    if Selected then
                        if tonumber(v[2]) > 0 then 
                            ...
                            if (GetOnscreenKeyboardResult()) then
                                ...
                                if result then 
                                    result = result
                                    FGS_server_callback('vRP:LootBagTakeItem', LootBagIDNew, result, v[3])
                                end
                            end  
                        end
                    end
