RMenu.Add('vRPClothing', 'main', RageUI.CreateMenu("", "~b~Clothing Menu",1300,100, "fgsclothing", "fgsclothing"))
...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get('vRPClothing', 'clothingsubmenu')) then
        ...
        RageUI.DrawContent({ header = true, glare = true, instructionalButton = true}, function()
            ...
            RageUI.List("Vests", Kevlar.Max, Kevlar.Index, 'Texture Index: ' .. Kevlar.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 9, Kevlar.Index), { }, true, function(Hovered, Active, Selected, Index)
                Kevlar.Index = Index
                if Active then
                    SelectedOption = 9;
