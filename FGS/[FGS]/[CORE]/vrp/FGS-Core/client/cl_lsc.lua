...
---------Suspension-----------
	[15] = {
		...
		{name = "Sport Suspension",mod = 2, price = 35000},
...
--Setup main menu
local LSCMenu = Menu.new("London Customs","CATEGORIES", 0.16,0.13,0.24,0.36,0,{255,255,255,255})
...
local function DriveInGarage()
	...
	if DoesEntityExist(veh) then
		...
		if currentgarage == 4 or currentgarage == 5 then
			LSCMenu:setTitle("London Customs")
			LSCMenu.title_sprite = "shopui_title_carmod"
		elseif currentgarage == 6 then
			LSCMenu:setTitle("London Customs")
			LSCMenu.title_sprite = "shopui_title_carmod" --shopui_title_supermod shopui_title_carmod2
		else
			LSCMenu:setTitle("London Customs")
			LSCMenu.title_sprite = "shopui_title_carmod"
		end
									...
									if pos.locked then
										...
										if not LSC_Config.lock then
											if IsControlJustPressed(1,201,true) then
												...
												drawTxt("Press ~b~ENTER~w~ to enter ~b~London Customs ",4,1,0.5,0.8,1.0,255,255,255,255)
											end
										else
...
--			AddTextComponentString("London Garage")
	--		EndTextCommandSetBlipName(blip)
--		elseif i == 6 then
--			BeginTextCommandSetBlipName("STRING")
--			AddTextComponentString("London Motorworks")
--			EndTextCommandSetBlipName(blip)
--		end
--	end
--end
