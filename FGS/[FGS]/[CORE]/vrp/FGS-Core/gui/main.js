window.addEventListener("load", function() {
    ...
    ofgsMenu.onClose = function() {
        $.post("https://vrp/menu", JSON.stringify({ act: "close", id: ofgsMenu.id }));
    };

    ofgsMenu.onValid = function(choice, mod) {
        $.post("https://vrp/menu", JSON.stringify({ act: "valid", id: ofgsMenu.id, choice: choice, mod: mod }));
    };
