...
vRPConfig.EnableHealthRegen = false; -- Controls the health regen. (Whether they regen health after taking damage do not disable if coma is enabled.)
...
vRPConfig.AdminCooldownTime = 120; -- 2 minute in (seconds) duration of cooldown. 
...
vRPConfig.ServerName = "FGS" -- Controls the name that is displayed on warnings title etc.
vRPConfig.PlayerSavingTime = 1500 -- Time in milliseconds to update Player saving
---------------
