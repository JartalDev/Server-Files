...
RegisterNetEvent("nui_doorlock:setSpawn", function()
	esxLoaded = true
end)
...
Citizen.CreateThread(function()
	...
	TriggerServerCallback('nui_doorlock:getDoorList', function(doorList)
...
RegisterCommand('doorlock', function()
	if closestDoor.id and not isCuffed then
...
function vRPDumpTable(table, nb)
	if nb == nil then
		nb = 0
	end
