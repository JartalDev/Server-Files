...
Config.Color            = "rgba(0, 0, 255, 1.0)"    -- Progress bar colour
Config.BGColor          = "rgba(255, 0, 0, 0.4)"          -- Progress background colour
Config.ZoneColor        = "rgba(255, 0, 0, 1)"        -- Minigame Zone colour

Config.x            = 0.5 -- Horizontal position
Config.y            = 0.5 -- Vertical position

Config.Rotation     = -120         -- Rotation angle of dial
Config.MaxAngle     = 240       -- Max arc in degrees - 360 will be a full circle, 90 will be a quarter of a circle, etc
