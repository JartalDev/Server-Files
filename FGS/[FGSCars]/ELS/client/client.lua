RequestScriptAudioBank("DLC_WMSIRENS\\SIRENPACK_ONE", false) -- request
    ...
    while true do
        ...
        if isVehicleELS and canControlELS and networkSessionActive then
            ...
            if(GetLastInputMethod(0)) then
				...
				DisableControlAction(0, controller.siren.tone_four, true)
                ...
                Down here I added al the key controls, you can change that in the config.lua
