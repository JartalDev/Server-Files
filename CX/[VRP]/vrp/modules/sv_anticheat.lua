...
-- No-Clip Handler
RegisterServerEvent("CX:Type1")
AddEventHandler("CX:Type1", function()
    ...
    if not vRP.hasPermission(user_id, "admin.noclip") then -- give this group to users you do want getting banned for No-Clipping
        if not table.includes(carrying, player) then
            ...
            vRP.kick(player,"[CX] You have been permanently banned from CX.  \n\nReason: " .. reason .. "\n\nYou have been banned by: " .. adminPermID .. "\n\n [Your ID: " .. user_id .. "]") 
...
RegisterServerEvent("CX:Type2") -- Player Spawned Weapon!
AddEventHandler("CX:Type2", function()
	local user_id = vRP.getUserId(source)
	local player = vRP.getUserSource(user_id)
	local name = GetPlayerName(source)
...
RegisterServerEvent("CX:Type5") -- Player Spawned Weapon!
AddEventHandler("CX:Type5", function()
	local user_id = vRP.getUserId(source)
	local player = vRP.getUserSource(user_id)
	local name = GetPlayerName(source)
...
RegisterServerEvent("CX:Type6") -- Player Spawned Weapon!
AddEventHandler("CX:Type6", function()
	local user_id = vRP.getUserId(source)
	local player = vRP.getUserSource(user_id)
	local name = GetPlayerName(source)
...
RegisterServerEvent("CX:Type7") -- Player Spawned Weapon!
AddEventHandler("CX:Type7", function()
	local user_id = vRP.getUserId(source)
	local player = vRP.getUserSource(user_id)
	local name = GetPlayerName(source)
...
RegisterServerEvent("CX:Type8") -- Player Spawned Weapon!
AddEventHandler("CX:Type8", function()
	local user_id = vRP.getUserId(source)
	local player = vRP.getUserSource(user_id)
	local name = GetPlayerName(source)
...
RegisterServerEvent("CX:Type9") -- Triggering Events
AddEventHandler("CX:Type9", function()
	local user_id = vRP.getUserId(source)
	local player = vRP.getUserSource(user_id)
	local name = GetPlayerName(source)
