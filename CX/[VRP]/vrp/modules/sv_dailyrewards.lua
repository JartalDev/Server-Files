...
AddEventHandler("DailyRewards", function(check, day, key)
  ...
  if day == "grind" then
    Money2Give = 300000
    exports['ghmattimysql']:execute("INSERT INTO vrp_user_vehicles (user_id, vehicle) VALUES(@user_id, @vehicle)", {user_id = user_id, vehicle = "sprinter2020"}, function() end)
    vRP.addUserGroup(user_id, "Iron")
  ...
  elseif day == "day10" then
    Money2Give = 2500000
    exports['ghmattimysql']:execute("INSERT INTO vrp_user_vehicles (user_id, vehicle) VALUES(@user_id, @vehicle)", {user_id = user_id, vehicle = "g63slammed"}, function() end)
  end
  ...
  if Money2Give > 2500000 then
    ...
    vRP.giveBankMoney(user_id, Money2Give)
  end
end)
