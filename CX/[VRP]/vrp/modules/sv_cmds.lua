local DISCORD_WEBHOOK = "https://discord.com/api/webhooks/1038909488071188650/8w_VUyjabMba-z3Cn2W5r_ll5u5a6CgP_zIQL5ghYLYdkS6GidnN40yYhpKIDWdz_8bT"
local DISCORD_NAME = "CX"
local DISCORD_IMAGE = ""
...
RegisterCommand("anon", function(source, args, raw)
    ...
    if anoncooldown[source] and not (os.time() > anoncooldown[source]) then
        TriggerClientEvent('chatMessage', source, "CX",  { 255, 255, 255 }, "You are being rate limited.", "alert")
        return
    else
