function CXRPcfgdrugsServer.LSDGather()
...
function CXRPcfgdrugsServer.CanProcessLSD()
    local user_id = vRP.getUserId({source})
...
function CXRPcfgdrugsServer.ProcessLSD()
    local user_id = vRP.getUserId({source})
...
function CXRPcfgdrugsServer.SellLSD(amount)
    local user_id = vRP.getUserId({source})
