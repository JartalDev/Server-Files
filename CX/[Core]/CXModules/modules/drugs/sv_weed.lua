function CXRPcfgdrugsServer.WeedGather()
...
function CXRPcfgdrugsServer.CanProcessWeed()
    local user_id = vRP.getUserId({source})
...
function CXRPcfgdrugsServer.ProcessWeed()
    local user_id = vRP.getUserId({source})
...
function CXRPcfgdrugsServer.SellWeed(amount)
    local user_id = vRP.getUserId({source})
