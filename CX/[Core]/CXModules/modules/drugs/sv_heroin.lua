function CXRPcfgdrugsServer.HeroinGather()
...
function CXRPcfgdrugsServer.CanProcessHeroin()
    local user_id = vRP.getUserId({source})
...
function CXRPcfgdrugsServer.ProcessHeroin()
    local user_id = vRP.getUserId({source})
...
function CXRPcfgdrugsServer.SellHeroin(amount)
    local user_id = vRP.getUserId({source})
