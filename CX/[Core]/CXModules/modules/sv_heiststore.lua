...
-- RegisterNetEvent("CXRP:BuyHeistItem")
-- AddEventHandler("CXRP:BuyHeistItem", function(itemID, amount)
...
-- RegisterNetEvent("CXRP:SellHeistItem")
-- AddEventHandler("CXRP:SellHeistItem", function(itemID, amount)
--     local user_id = vRP.getUserId({source})
