...
RegisterServerEvent("CXRP:BuyGun")
AddEventHandler('CXRP:BuyGun', function(hash)
    local source = source
...
RegisterServerEvent("CXRP:BuyArmour")
AddEventHandler('CXRP:BuyArmour', function(price, amount)
    local source = source
