...
QBConfig.Server.Discord = "discord.gg/blackoutrp" -- Discord invite link
QBConfig.Server.CheckDuplicateLicense = true -- Check for duplicate rockstar license on join
QBConfig.Server.Permissions = { 'god', 'admin', 'mod', 'founder', 'staffmanager', 'leaddev', 'developer' } -- Add as many groups as you want here after creating them in your server.cfg
