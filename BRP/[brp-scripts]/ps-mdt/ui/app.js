...
$(document).ready(() => {
  ...
  $(".contextmenu").on("click", ".toggle-duty", function () {
    ...
    if (currentStatus == "State-1") {
      $(`[data-id="${info}"]`).find(".unit-status").html("State-11");
      $(`[data-id="${info}"]`)
        .find(".unit-status")
    ...
    } else if (currentStatus == "State-11") {
      $(`[data-id="${info}"]`).find(".unit-status").html("State-1");
      $(`[data-id="${info}"]`)
        .find(".unit-status")
  ...
  function JobColors(sentJob) {
    if (sentJob) {
      if (PoliceJobs[sentJob] !== undefined)  {
        if (sentJob == "police") {
            applyCustomTheme(customThemes.police)
