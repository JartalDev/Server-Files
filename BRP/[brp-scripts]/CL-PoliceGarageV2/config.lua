...
Config.BanWhenExploit = true -- Set to true if you want to ban players / cheaters when buying items without the job (Just another safety system (: )
        ...
        ["MRPD"] = {
            ...
            VehiclesInformation = {
                PurchaseVehicles = { -- Purchasable vehicles, make sure you have the vehicle information set in qb-core > shared > vehicles.lua
                    ["FBI"] = { -- Vehicle name goes here
                        ...
                        TotalPrice = 1, -- The total price it costs to buy this vehicle
            ...
            GeneralInformation = {
                Blip = { -- If UseTarget set to true it uses the target ped coords and if false it uses the marker coords
                    ...
                    Title = "Met Police - Garage" -- The blip title string
                },
